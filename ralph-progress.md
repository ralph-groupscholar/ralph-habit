# ralph-habit Progress

## Iteration 1
- Initialized project and built a simple CLI for adding, listing, and completing habits.
...
## Iteration 20
- Added CSV import/export commands with optional update/replace behavior for sharing and backup.
